...
function imprimirFuncionario(funcId) {
  ...
  var css =
    ...
    '.recibo{width:210mm;height:139mm;padding:5mm 14mm;display:flex;flex-direction:column;overflow:hidden;flex-shrink:0}' +
    ...
    '.rec-header{display:flex;justify-content:space-between;align-items:center;padding-bottom:5px;border-bottom:3px solid #cc2222;margin-bottom:6px}' +
    '.rec-mra-box{display:inline-flex;flex-direction:column;align-items:center;border:2.5px solid #111;border-radius:2px;padding:4px 14px;line-height:1;gap:1px}' +
    ...
    '.rec-section{margin-bottom:5px;padding-bottom:3px;border-bottom:1px solid #ddd}' +
    ...
    '.rec-label{font-size:9px;text-transform:uppercase;color:#999;letter-spacing:.3px}' +
    '.rec-value{font-size:13px;color:#1a1a1a}.bold{font-weight:700}.red{color:#cc2222}' +
    '.rec-rescisao{background:#fff0f0;border:1px solid #ffcccc;border-radius:3px;padding:3px 6px;font-size:10px;color:#cc2222;font-weight:600;margin-top:2px}' +
    '.rec-table{width:100%;border-collapse:collapse;margin-bottom:4px}' +
    '.rec-table thead th{background:#cc2222;color:#fff;padding:5px 8px;font-size:12px;text-transform:uppercase}' +
    '.rec-table tbody td{padding:4px 8px;border-bottom:1px solid #eee;font-size:13px}' +
    ...
    '.rec-total td{font-weight:700;padding:6px 8px;border-top:2px solid #cc2222;background:#fff5f5;font-size:15px}' +
    ...
    '.rec-ass-texto{font-size:11px;color:#333;margin-bottom:8px;line-height:1.5;text-align:justify;font-weight:500}' +
    ...
    '.rec-ass-label{font-size:11px;font-weight:700;color:#222}' +
