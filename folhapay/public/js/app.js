...
function imprimirFuncionario(funcId, btn) {
  ...
  var html = '<html><head><meta charset="UTF-8"><title>Recibo — '+f.nome+'</title><style>' +
    ...
    '.rec-header{display:flex;justify-content:space-between;align-items:center;padding-bottom:3px;border-bottom:2px solid #cc2222;margin-bottom:5px}' +
    ...
    '.rec-section-title{font-size:7px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:#cc2222;margin-bottom:3px;padding-bottom:2px;border-bottom:1px solid #ffcccc}' +
